...
def gen_xml(msgid):
	...
	code = '04,25,26,27,28,30|02$04,25,26,27,28,30|03$04,25,26,27,28,30|04$04,25,26,27,28,30|05$04,25,26,27,28,30|06'
	#code = '01,05,06,08,09,10|09$01,04,09,16,30,31|11'
	zhushu = '5'
	multiple = '1'
	ticketcount = '1'
...
def post_xml(tid, msgid):
	...
	while i < 1:
		...
		try:
			request = urllib2.Request("http://172.16.45.209:8080/venus/LotteryOrderTCServlet", data)
