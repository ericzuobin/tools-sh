...
def gen_xml(msgid):
	...
	body = '<body><lottype>%s</lottype></body>' % (
		lottype)
...
def post_xml(tid, msgid):
	...
	while i < msgid:
		...
		try:
                        #request = urllib2.Request("http://172.16.45.37:8080/venus/LotteryOrderTCServlet", data)
                        request = urllib2.Request('http://172.16.3.81:9121/LotteryOrderTCServlet', data)
